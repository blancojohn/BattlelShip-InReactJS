...
import { buildBoard, firstBoardMachine, secondBoardMachine, thirdBoardMachine } from "./functions";
import Messagge from "./components/Messagge";
import { GrUpdate } from "react-icons/gr";


const App = () => {
    /* const [shipsMachine, setShipsMachine]= useState(false) */
    ...
    const [boardMachine, setBoardMachine] = useState(thirdBoardMachine());
    ...
    /* const showShipsMachine= ()=>{
        setShipsMachine(true)
    } */
    ...
    return (
        <>
            ...
            }
            {
                (winMachine == 17) &&
                    <Messagge>
                        ...
                        {/* <button onClick={showShipsMachine} className="btn btn-primary">VER</button> */}
                    </Messagge>
            }
            <div className="d-flex">
                ...
                <Machine setTurn={setTurn} boardMachine={boardMachine} setBoardMachine={setBoardMachine} human={human} winMachine={winMachine} setWinMachine={setWinMachine} winHuman={winHuman} setWinHuman={setWinHuman} newGameMachine={newGameMachine} setNewGameMachine={setNewGameMachine} /* shipsMachine={shipsMachine} setShipsMachine={setShipsMachine} *//>
            </div>
        </>
    )
}
